...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改新闻</h2>
		<div class="manage">
			<form action="news_update.do">
				<table class="form">
					<tr>
						<td class="field">新闻标题：</td>
						<td><input type="text" class="text" name="news.en_title" value="${news.en_title}" /></td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea name="news.en_content">${news.en_content}</textarea></td>
					</tr>
					<tr>
						<td></td>
