...
public class Easybuy_product {
	...
	public String getEp_bar_code() {
		return ep_bar_code;
	}
	public void setEp_bar_code(String ep_bar_code) {
		this.ep_bar_code = ep_bar_code;
	}
	...
	public String toString() {
		return "Easybuy_product [ep_id=" + ep_id + ", ep_name=" + ep_name + ", ep_description=" + ep_description
				...
				+ epc_child_id + ", ep_file_name=" + ep_file_name + ", ep_brand=" + ep_brand + ", ep_bar_code="
				+ ep_bar_code + "]";
	}
